...
llm_tokens_total = Counter(
    "cvilwar_llm_tokens_total",
    "Total LLM tokens consumed",
    ["provider", "model", "direction"],
)

llm_cost_usd = Counter(
    "cvilwar_llm_cost_usd_total",
    "Cumulative LLM cost in USD",
    ["provider", "model"],
)

llm_requests_total = Counter(
    "cvilwar_llm_requests_total",
...
queue_processing_duration_seconds = Histogram(
    "cvilwar_queue_processing_duration_seconds",
...
documents_generated_total = Counter(
    "cvilwar_documents_generated_total",
